...
const UniversityRepresentativeCounsellingPage: React.FC = () => (
  ...
  >
    ...
    <div style={{
      ...
      University Representative Counselling — <span style={{ color: '#5727A3', background: '#fff', borderRadius: 8, padding: '0.2rem 0.7rem', marginLeft: 8 }}>Coming Soon</span>
    </div>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 320, textAlign: 'left' }}>
          ...
          <p style={{
            ...
            Get exclusive access to official university representatives. Ask questions, get real answers, and make informed decisions about your academic journey — all in one place.
          </p>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img
                ...
                alt="University Representative Session"
                style={{
                  width: '100%',
                  height: '100%',
                  objectFit: 'cover',
